...
The linear regression line shown in the above graph is further detailed in the following table.
...
This table shows us that for every 10% increase in the average health spending per capita, our model predicts the average life expectancy to increase by about 0.33 years or about 4 months.
