...
From our statistical analysis above, we have evidence to conclude that there is an association between the average government health spending per person and the average life expectancy. Upon further inspection, we can see that the association is positive and relatively strong. Based on our scatterplot graph, there are couple of data points that are well below the trend line, specifically from Africa, which indicates that our model is better at predicting countries with a higher life expectancy. 
