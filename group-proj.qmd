...
We had a total of 33 missing values from health spending per capita. The main countries that had missing values were Afghanistan from 1995-2001 as well as Zimbabwe and Somalia from 2002-2010. We believe that these numbers are missing due to ongoing conflict in these countries during those time periods. Along with these main three, there were a few other countries with missing values for health care spending per capita, however, they appear to be missing at random since they are one-offs.
